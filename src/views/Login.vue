<template>
  <div class="login_container">
    <div class="login_box">
      ...
      >
      <!-- plus -->
        <el-form-item class="hydl"> 欢迎登录 </el-form-item>
        <!-- 用户名 -->
        <!-- main.js 中导入   import './assets/fonts/iconfont.css' -->
        <!-- prefix-icon="iconfont icon-user"    自带 : prefix-icon="el-icon-user-solid"-->
        ...
        <!-- 密码 -->
        <!-- prefix-icon="iconfont icon-3702mima"  自带 : prefix-icon="el-icon-info"-->
...
.login_box {
  ...
  .avatar_box {
    height: 150px;
    width: 150px;
    border: 1px solid rgb(120, 200, 231);
    border-radius: 50%;
    // padding: 10px;
    //box-shadow: rgb(252, 128, 200) 5px 5px 10px;
    box-shadow: rgb(252, 128, 200) 0px 0px 20px;
    position: absolute;
    left: 50%;
    transform: translate(-50%, -50%);
    // background-color: #fff;
